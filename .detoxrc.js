...
module.exports = {
  ...
  apps: {
    ...
    'android.release': {
      ...
      build:
        'cd android && EXPO_PUBLIC_IS_E2E=TRUE && ./gradlew clean && ./gradlew assembleRelease assembleAndroidTest -DtestBuildType=release -PreactNativeArchitectures=arm64-v8a,armeabi-v7a && cd ..',
    },
